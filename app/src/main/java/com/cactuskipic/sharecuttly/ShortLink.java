...
public class ShortLink{
    ...
    public static boolean ShortLink(CuttlyActivity activity, String url){
        return ShortLink(activity, url, "");
    }
    
    public static boolean ShortLink(CuttlyActivity activity, String url, String name){
        ...
        if(!Patterns.WEB_URL.matcher(url).matches()){
            Toast.makeText(activity.getApplicationContext(),"Given URL is not a valid URL", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        Toast.makeText(activity.getApplicationContext(),"Shorting URL", Toast.LENGTH_SHORT).show();
        return true;
    }
